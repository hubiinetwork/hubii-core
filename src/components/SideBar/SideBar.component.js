...
class SideBar extends React.Component {
  constructor(props) {
    ...
    this.state = {
      selectedKey: menuItems[0].to,
    };
    this.handleChange = this.handleChange.bind(this);
  }
  handleChange({ key: selectedKey }) {
    ...
    return (
      <SideBarLayout style={{ minHeight: '100vh' }}>
        <Sider collapsed collapsedWidth="72" trigger={null}>
          <SideBarMenu defaultSelectedKeys={[menuItems[0].to]} mode="inline" onSelect={this.handleChange}>
                      ...
                      {menuItem.icon === 'wallet' && (
                        <SvgIcon>
                          <path
                            ...
                            fill={selectedKey === menuItem.to ? info : dark2}
                          />
                        </SvgIcon>
                      )}
