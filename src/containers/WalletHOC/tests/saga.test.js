...
describe('load wallets saga', () => {
  ...
  describe('payment transfer', () => {
    ...
    xdescribe('hardware wallet: trezor', () => {
      ...
      it('should derive child keys from parent key', () => {
        const deviceId = '123';
        const storeState = {
          walletHoc: {
            trezorInfo: {
        ...
        const expectedAddresses = [
          'd03c200c7d655e5170e28e61595683c8d7a6494e',
          '9d7b7f53ce6a179274068a8050a15c9b8657a018',
          'fdfa888b8a6b81572444283e694ac78ececb1c24',
          'b501600b8554d3f557ae73fe68fe3a24e11633cb',
          '2cafdc27dad30f8d5192ead09e7a2ee36a771a13',
        ];
        const count = 5;
