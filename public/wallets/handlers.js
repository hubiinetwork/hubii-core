...
const loadHandlers = async () => {
  ...
  const lnsHandlerModule = (await require('electron-remote').rendererRequireDirect(path.join(require('electron').app.getAppPath(), 'build/public/wallets/lns/index.js'))).module;
  const handlers = {
